...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audio_player__ = __webpack_require__(29);
 ...
 */
window.createPlayer = function (props, domEl) {
    __WEBPACK_IMPORTED_MODULE_0_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__audio_player__["a" /* AudioPlayer */], props), domEl);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_svgs__ = __webpack_require__(30);
    ...
    _createClass(AudioPlayer, [{
        ...
        value: function componentDidMount() {
            ...
            this.audio.onended = function () {
                if (_this2.state.audios.length > 1) {
                    _this2.setState(function (prev) {
                        prev.currentKey = (prev.currentKey + 1) % prev.audios.length;
                        _this2.ulList.scrollTop = prev.currentKey * 16;

                        return prev;
                    });
                } else {
                    _this2.audio.currentTime = 0;
                    _this2.setState({ time: 0 });
                }
            };
            ...
            function setTimer() {
                ...
                this.currentTimeInterval = setInterval(function () {
                    _this3.setState({ time: _this3.audio.currentTime });

                    _this3.setCompleteValue(_this3.audio.currentTime);
                }, 500);
            }
        }
        ...
        key: "setCompleteValue",
        value: function setCompleteValue(value) {
            var completeValue = value / this.state.duration;

            //bad bad code. The solution would be to further customise slider
            var fix = completeValue < 0.7 ? " + 2px" : "";
        ...
        key: "handleItemClick",
        value: function handleItemClick(key) {
            var _this4 = this;
        ...
        key: "handleSlider",
        value: function handleSlider(event) {
        ...
        value: function handleNextClick() {
            ...
            this.setState(function (prev) {
                prev.currentKey = (prev.currentKey + 1) % prev.audios.length;
                prev.time = 0;
                _this5.audio.currentTime = 0;
                _this5.ulList.scrollTop = prev.currentKey * 16;
                return prev;
            });
        }
    }, {
        ...
        value: function handlePrevClick() {
            ...
            this.setState(function (prev) {
                ...
                _this6.ulList.scrollTop = prev.currentKey * 16;
                return prev;
            });
        }
    }, {
        ...
        value: function handlePlayPauseClick() {
            ...
            var isAudioSelected = this.state.currentKey >= 0;
            if (!isAudioSelected) {
        ...
        value: function render() {
            ...
            var isAudioSelected = currentKey >= 0;
            var src = isAudioSelected ? audios[currentKey].path : "";

            var hasPlaylist = audios.length > 1;
            var timeStr = createPlayerDuration(time, duration);

            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "audio-player" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("audio", { hidden: true, src: src,
                    ref: function ref(audio) {
                        return _this8.audio = audio;
                    },
                    autoPlay: isPlaying }),
                hasPlaylist && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "button",
                    { className: "button",
                        disabled: !isAudioSelected,
                        onClick: this.handlePrevClick.bind(this) },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_svgs__["d" /* Previews */], null)
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "button",
                    { className: "button",
                        onClick: this.handlePlayPauseClick.bind(this) },
                    isPlaying ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_svgs__["b" /* Pause */], null) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_svgs__["c" /* Play */], null)
                ),
                hasPlaylist && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "button",
                    { className: "button",
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_svgs__["a" /* Next */], null)
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "button volume range" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_svgs__["e" /* Volume */], { width: volume * 100 }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "range",
                        name: "volume",
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "range",
                        ...
                        value: time,
                        min: "0", max: duration }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "complete",
                        ref: function ref(complete) {
                            return _this8.complete = complete;
                        }
                ...
                hasPlaylist && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "ul",
                    { ref: function ref(ul) {
                            return _this8.ulList = ul;
                        } },
                    audios.map(function (item, i) {
                        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "li",
                            { key: i,
                                onClick: _this8.handleItemClick.bind(_this8, i),
...
function createPlayerDuration(time, duration) {
    var _time = createTimeString(time);
    var _duration = createTimeString(duration);
...
/* harmony export (immutable) */ __webpack_exports__["d"] = Previews;
/* harmony export (immutable) */ __webpack_exports__["a"] = Next;
/* harmony export (immutable) */ __webpack_exports__["e"] = Volume;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/**
...
function Play() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "svg",
        { width: "22.5", height: "27", viewBox: "0 0 22.5 27" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("polygon", { "data-name": "play", fill: "#47cdff", points: "0 27 22.5 13.5 0 0 0 27" })
    );
}
...
function Pause() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "svg",
        { width: "22.5", height: "27", viewBox: "0 0 22.5 27" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("path", { "data-name": "pause", fill: "#47cdff", d: "M0,0H9V27H0ZM13.5,0h9V27h-9Z" })
    );
}
...
function Previews() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("path", { id: "back-2", "data-name": "back", fill: "#47cdff", d: "M9,16.2V10.8L27,0V27ZM9,0H0V27H9Z" })
    );
}
...
function Next() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "svg",
        { width: "27", height: "27", viewBox: "0 0 27 27" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("path", { id: "next-2", "data-name": "next", fill: "#47cdff", d: "M18,10.8v5.4L0,27V0ZM18,27h9V0H18Z" })
    );
}
...
function Volume(props) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "svg",
        { width: "54", height: "27", viewBox: "0 0 54 27" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "defs",
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("stop", { offset: "0%", style: { stopColor: "#47cdff", stopOpacity: 1 } }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("stop", { offset: width + "%", style: { stopColor: "#47cdff", stopOpacity: 1 } }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("stop", { offset: width + 1 + "%", style: { stopColor: "#66697a", stopOpacity: 1 } }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("stop", { offset: "100%", style: { stopColor: "#66697a", stopOpacity: 1 } })
            )
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("path", { "data-name": "sound", fill: "url(#grad1)",
